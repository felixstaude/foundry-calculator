...
function ProductionGraph({
  ...
  const [nodes, setNodes] = useState(initialLayout.rfNodes);
  const [edges, setEdges] = useState(initialLayout.rfEdges);
  useEffect(() => {
    setNodes(initialLayout.rfNodes);
    setEdges(initialLayout.rfEdges);
  }, [initialLayout]);
